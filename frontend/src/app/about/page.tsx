...
const AboutPage = () => {
    ...
    <div id="header" className="flex h-full  justify-center bg-center bg-cover bg-darkestBlue"
        ...
        <div id="header" className="flex flex-col w-full h-full mx-70 mt-50 items-center relative gap-40">
            ...
            <div className="flex flex-col relative w-full items-center" >
                ...
                <div className="flex flex-col  justify-center w-full min-w-[700px] h-[350px] from-darkestBlue to-darkerBlue bg-linear-to-b rounded-2xl drop-shadow-xl relative">
            ...
            <div className="flex flex-col h-[700px] relative w-full items-center justify-center">    
                ...
                <iframe width="720" height="405" src="https://www.youtube.com/embed/INs-bngIeVs?si=6fquNJwfbpF0Cfnf" title="YouTube video player" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
                </div>
            ...
            <div className="flex flex-col relative h-[100px] w-full items-center justify-center mb-60">    
                ...
                <div className="relative flex w-[50%] h-[250px] bg-linear-to-b from-[#440813] to-[#A5081D] mt-5 rounded-xl border-4 border-[#660618]">
