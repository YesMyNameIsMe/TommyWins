    ...
    <div className={`flex justify-center min-w-full bg-darkBlue bg-center bg-cover bg-no-repeat`} 
        ...
        <div id="header" className="flex flex-col h-full w-full items-center relative overflow-hidden">
          ...
          <motion.div className="items-center justify-center flex mt-5 gap-4 flex-wrap" initial={{y: 20, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{duration: 0.5, type: 'tween', delay: 0.6}}>
            <LinkBubble name="Figma" image="/assets/general/FigmaLogo.png" link="https://www.figma.com/design/JeqUDJbOypDKXkkqVOhOH9/Nexus-Portfolio?node-id=0-1&t=zrXA9RM5rf7L5QWT-1"/>
          ...
          <div className="relative flex flex-col justify-center items-center mt-30">
            ...
            <LinkBubble className='mt-5' link='https://www.figma.com/proto/JeqUDJbOypDKXkkqVOhOH9/Nexus-Portfolio?node-id=0-1&t=zrXA9RM5rf7L5QWT-1' name='Prototype Link' image='/assets/general/FigmaLogo.png'/>
          </div>
          {/*============================== DESIGN ==============================*/}
