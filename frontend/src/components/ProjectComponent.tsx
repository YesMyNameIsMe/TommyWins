  ...
  return (
    ...
    <>
      ...
      <div className="flex relative w-full">
        <div className={`flex flex-row justify-center min-w-[500px] h-[320px] bg-linear-to-b from-darkestBlue to-darkBlue rounded-xl drop-shadow-2xl py-4 pl-4
                         text-4xl font-bold text-white ${isHovered ? '' : 'overflow-hidden'} ${isTinyMobile ? 'scale-80' : isMobile ? 'scale-90' : ''}`} >
      ...
      // =========================== NOT NEWEST ================================
      <div className="flex relative">
        <div className={`flex flex-row justify-start max-w-[550px] h-[320px] bg-linear-to-b from-darkestBlue to-darkBlue rounded-xl drop-shadow-2xl p-4
                         text-4xl font-bold text-white ${isHovered ? '' : 'overflow-hidden'} ${isTinyMobile ? 'scale-80' : isMobile ? 'scale-90' : ''}`} >
