...
const SkillList = ({ className, skills }: SkillListProps) => {
  return (
    <div className={`${className} flex flex-wrap min-w-[500px] min-h-[150px] gap-4 items-center justify-center bg-linear-to-b from-darkestBlue to-darkerBlue drop-shadow-xl p-6 rounded-2xl select-none`}>
